...
IF ~~ THEN DO ~Enemy()SetGlobal("CO#QuestPart","GLOBAL",5)~ UNSOLVED_JOURNAL %Aliennes Entfühung
...
IF ~Global("CO#Corrupt100","GLOBAL",0)~ THEN REPLY ~Nun, vielleicht kann das Klimpern von 100 Goldmünzen euch ja umstimmen?~ DO ~SetGlobal("CO#Corrupt100","GLOBAL",1)TakePartyGold(100)~ GOTO CorruptFail100
IF ~Global("CO#Corrupt300","GLOBAL",0)~ THEN REPLY ~Wie wär’s mit 300 Goldmünzen, würde das Eure Zunge lockern?~ DO ~SetGlobal("CO#Corrupt300","GLOBAL",1)TakePartyGold(300)~ GOTO CorruptFail300
...
IF ~~ THEN DO ~GiveItem("CO#scrl1",LastTalkedToBy())SetGlobal("CO#QuestPart","GLOBAL",5)EscapeAreaDestroy(10)~ UNSOLVED_JOURNAL %Aliennes Entfühung
