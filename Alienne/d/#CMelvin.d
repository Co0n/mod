...
IF ~!Global("#CQuestPart","GLOBAL",5)NumTimesTalkedTo(0)~ THEN BEGIN InitialTalk
...
IF ~HasItem("#Cscrl1",LastTalkedToBy())Class(LastTalkedToBy,MAGE_ALL)~ THEN REPLY ~(Die Befehle überreichen) Ich heiße Aeri, ich soll hier für Euch arbeiten.~ GOTO Mage
IF ~HasItem("#Cscrl1",LastTalkedToBy())!Class(LastTalkedToBy,MAGE_ALL)~ THEN REPLY ~(Die Befehle überreichen) Ich heiße Aeri, ich soll hier für Euch arbeiten.~ GOTO Work
